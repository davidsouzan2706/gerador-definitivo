...
#Highly stylized 2D illustration in the distinct Gacha Life / Gacha Club art style. Characters feature exaggerated chibi proportions with large heads, small bodies, and simplified limbs. Crisp, clean, and consistent black outlines define all elements. Colors are flat and vibrant, with minimal, soft cell-shading applied only to key areas (e.g., under hair, inside clothing folds) to suggest form, avoiding complex gradients or realistic textures. Eyes are large, expressive, and glossy, with simple, bright highlights. Mouths are small and often depicted as a simple line or a 'D' shape. Facial expressions are cute and charming, often with subtle blush marks on the cheeks. Clothing and accessories are simplified, focusing on clear shapes rather than intricate details. The overall aesthetic is clean, cute, and digitally rendered with a focus on character design. Backgrounds are typically solid colors or very simple, abstract patterns, ensuring the character stands out.

--no realistic, photorealistic, 3d, cgi, complex shading, gradients, detailed textures, human proportions, detailed anatomy, rough lines, blurry, messy, dark, gritty, horror, old, vintage, traditional art, watercolor, oil painting, pencil sketch, anime (unless specified as Gacha style), manga, detailed backgrounds, complex environments`
    }
